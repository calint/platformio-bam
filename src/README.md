...
* source in `hpp` files
  ...
  * increases compile time and is not scalable; however, compilation time for
    this application is negligible
...
* include order relevant
  * subsystems are included in dependency order making the program readable
    top-down
* `inline` functions
...
* naming convention:
  ...
  * snake case
  * lower case
  * private class members have suffix `_`
