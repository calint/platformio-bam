...
class JC4827W543C final : public device {
  ...
  public:
    auto init() -> void override {
        // printf("touch sda %u, sck %u, irq %u, rst %u, width %u, height %u\n",
        //        TOUCH_SDA, TOUCH_SCK, TOUCH_IRQ, TOUCH_RST, TFT_WIDTH,
        //        TFT_HEIGHT);
  ...
  private:
    static auto pre_transaction_cb(spi_transaction_t* trans) -> void {
        JC4827W543C* dev = static_cast<JC4827W543C*>(trans->user);
